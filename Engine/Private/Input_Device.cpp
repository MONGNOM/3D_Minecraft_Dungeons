...
{
	memcpy_s(&m_prevKeyState, sizeof(m_prevKeyState), &m_byKeyState, sizeof(m_byKeyState));
	memcpy_s(&m_tprevMouseState, sizeof(m_tprevMouseState), &m_tMouseState, sizeof(m_tMouseState));
