...
public:
	...
	virtual HRESULT Static_BinaryInitialize(MODEL eType, VTXMESH* pVertices, _uint iNumVertices, _ulong* pIndices, _uint iNumIndices, _uint iMaterialIndex, _fmatrix PreTransformMatrix);
	virtual HRESULT Dynamic_BinaryInitialize(MODEL eType, VTXANIMMESH* pVertices, _uint iNumVertices, _ulong* pIndices, _uint iNumIndices, _uint iMaterialIndex, _fmatrix PreTransformMatrix, _int iNumBonesInMesh, ifstream& fin);
...
public:
	...
	static CMesh* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, MODEL eType, VTXANIMMESH* pVertices, _uint iNumVertices, _ulong* pIndices, _uint iNumIndices, _uint iMaterialIndex, _fmatrix PreTransformMatrix, _int iNumBonesInMesh, ifstream& fin);
