...
void Enable_Console()
{
    ...
    if (hConsole)
    {
        // 위치/크기 지정 (x=50, y=300, width=800, height=500)
        MoveWindow(hConsole, 50, 300, 800, 500, TRUE);
    }
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SETCURSOR:
        ...
        //{
        //    // "내가 만든 칼 모양 커서로 그려줘!" 라고 윈도우에게 지시합니다.
        //    SetCursor(g_hCustomCursor);

        //    // "내가 직접 커서를 처리했으니까, 윈도우 넌 기본 화살표 그리지 마!" 라는 뜻의 TRUE 반환
        //    return TRUE;
        //}
        // 마우스 커서 바꾸기
        //return true;
