...
CItem_Armor::CItem_Armor(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CItemObject{ pDevice, pContext }
{
}

CItem_Armor::CItem_Armor(const CItem_Armor& Prototype)
	: CItemObject(Prototype)

{
}

HRESULT CItem_Armor::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CItem_Armor::Initialize(void* pArg)
{
...
void CItem_Armor::Priority_Update(_float fTimeDelta)
{

}

void CItem_Armor::Update(_float fTimeDelta)
{
...
void CItem_Armor::Late_Update(_float fTimeDelta)
{
	m_pGameInstance->Add_RenderGroup(RENDERGROUP::NONBLEND, this);
}

HRESULT CItem_Armor::Render()
{
...
_bool CItem_Armor::Intersect_ToPlayer()
{
...
HRESULT CItem_Armor::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(ETOI(m_eSceneType), TEXT("Prototype_Component_Model_Armor"),
...
HRESULT CItem_Armor::Bind_ShaderResources()
{
...
CItem_Armor* CItem_Armor::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CItem_Armor* pInstance = new CItem_Armor(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CItem_Armor");
...
CGameObject* CItem_Armor::Clone(void* pArg)
{
	CItem_Armor* pInstance = new CItem_Armor(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CItem_Armor");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CItem_Armor::Free()
{
	__super::Free();
