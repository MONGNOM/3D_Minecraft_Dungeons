...
void CBridge::Update(_float fTimeDelta)
{
...
HRESULT CBridge::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(ETOI(LEVEL::DUNGEON), TEXT("Prototype_Component_Model_Bridge"),
...
HRESULT CBridge::Bind_ShaderResources()
{
