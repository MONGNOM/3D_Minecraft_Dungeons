...
CItem_Bow::CItem_Bow(const CItem_Bow& Prototype)
	: CItemObject(Prototype)

{
}

HRESULT CItem_Bow::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CItem_Bow::Initialize(void* pArg)
{
...
void CItem_Bow::Priority_Update(_float fTimeDelta)
{

}

void CItem_Bow::Update(_float fTimeDelta)
{
...
void CItem_Bow::Late_Update(_float fTimeDelta)
{
...
_bool CItem_Bow::Intersect_ToPlayer()
{
...
HRESULT CItem_Bow::Ready_Components()
{
...
HRESULT CItem_Bow::Bind_ShaderResources()
{
...
CItem_Bow* CItem_Bow::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CItem_Bow* pInstance = new CItem_Bow(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CItem_Bow");
...
CGameObject* CItem_Bow::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CItem_Bow");
		Safe_Release(pInstance);
	}
	return pInstance;
}
